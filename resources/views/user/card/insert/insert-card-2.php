                    ...
                    <div class="form__card">
                        <div class="form__pepctive">
                            <div class="form__card--from form__cards">
                                ...
                                <?php
                                    foreach ($mod['atributos'] as $atr):
                                ?>
                                    <li class="form__list"><?=$atr['descricao_item'] ?>: <span class="form__item"><?=$atr['descricao_atributo'] ?></span></li>       
                                <?php
                                    endforeach;
                                ?>
                                </ul>
                            ...
                            <div class="form__card--back form__cards">
                                ...
                                <a href="<?=url("usuario").'/'.$mod['id']?>" class="form__link">Alterar</a>
                            </div>
                        </div>
                    </div>
                <?php
